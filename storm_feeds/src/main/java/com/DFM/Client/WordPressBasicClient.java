...
public class WordPressBasicClient extends WordPressClient {
    ...
    public HashMap<String, String> put(String endpoint, WordPressPost wpp) throws IOException {
    ...
    public HashMap<String, String> uploadImage(String endpoint, String imageSource, String imageType, String imageName) throws IOException, ParseException {
